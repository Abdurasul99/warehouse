...
abstract class AppLocalizations {
  ...
  /// No description provided for @auth_btn_have_account.
  ///
  /// In uz, this message translates to:
  /// **'Hisobingiz bormi? Kirish'**
  String get auth_btn_have_account;

  /// No description provided for @auth_btn_no_account.
  ///
  /// In uz, this message translates to:
  /// **'Hisob yo\'qmi? Ro\'yxatdan o\'ting'**
  String get auth_btn_no_account;
  ...
  /// No description provided for @auth_role_label.
  ///
  /// In uz, this message translates to:
  /// **'Rol'**
  String get auth_role_label;
  ...
  /// No description provided for @auth_error_username_taken.
  ///
  /// In uz, this message translates to:
  /// **'Bu foydalanuvchi nomi band'**
  String get auth_error_username_taken;

  /// No description provided for @auth_error_name_required.
  ///
  /// In uz, this message translates to:
  /// **'Ism majburiy'**
  String get auth_error_name_required;
  ...
  /// No description provided for @auth_success_registered.
  ///
  /// In uz, this message translates to:
  /// **'Muvaffaqiyatli ro\'yxatdan o\'tdingiz'**
  String get auth_success_registered;
}
