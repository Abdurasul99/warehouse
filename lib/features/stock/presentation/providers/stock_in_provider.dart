...
final stockInProvider = NotifierProvider<StockInNotifier, StockInFormState>(StockInNotifier.new);

class StockInNotifier extends Notifier<StockInFormState> {
  @override
  StockInFormState build() => const StockInFormState();
  ...
  Future<bool> submit() async {
    ...
    if (productIndex == -1) {
      state = state.copyWith(isSubmitting: false, error: 'Mahsulot topilmadi');
      return false;
    }
  ...
  void reset() => state = const StockInFormState();
}
